...
> For development and collaboration, the `.Rprofile`, `renv.lock`, `.Rprofile` 
...
6. Put the `.Rprofile`, `renv.lock`, `.Rprofile` and `renv/activate.R` files under local 
...
5. Put the `.Rprofile`, `renv.lock`, `.Rprofile` and `renv/activate.R` files under local 
...
#### talk slides: *[bit.ly/SES_Workshop_2022](https://bit.ly/SES_Workshop_2022)*
