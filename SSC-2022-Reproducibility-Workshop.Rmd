---
title: "SSC 2022 Reproducibility Workshop"  
author: 
  - "Tiffany Timbers (UBC) and Wesley Burr (Trent)"
  - "`r Sys.Date()`"
date: '*https://bit.ly/SES_Workshop_2022*'
output:
...
* 04 - [Integration Version Control into your Workflow](04-integration-version-control-Rstudio.html)
* 05 - [Shareable Compute Environments](05-shareable-compute.html)
